    ...
    return (
        <div className="animate-fade-in pb-20 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <button onClick={() => props.onSetManagerType('basket')} className={BIG_BUTTON_STYLE}><FunnelIcon className={getIconStyle('text-indigo-400')} /><span className={BUTTON_TEXT_STYLE}>SITE (BASKETS)</span></button>
            </div>
            <div className="grid grid-cols-2 gap-4">
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                }} className={BIG_BUTTON_STYLE}>
                    <CloudArrowUpIcon className={getIconStyle('text-blue-400')} />
                    <span className={BUTTON_TEXT_STYLE}>CONECTARE GOOGLE DRIVE</span>
                </button>
            ...
            {/* 6. SECTION: ENGINE */}
            <div id="section-engine" className={`${SECTION_HEADER_STYLE} scroll-mt-24`} style={getDynamicSectionHeaderStyle()}>MOD ANALIZĂ</div>
            ...
            <div className="flex flex-col items-center gap-1 pb-4">
                <span className={FOOTER_TEXT_STYLE}>PHARMABARISTA EXPERT v7.0</span>
